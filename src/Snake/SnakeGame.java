...
public class SnakeGame extends Applet implements Runnable, KeyListener {
    ...
    public void run() {
        for(;;) {
            ...
            this.repaint();
            try {
                //sleep will change how fast the snake is
                //lower it to make it faster/more difficult
                Thread.sleep(40);
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_UP) {
            //if snake not going down, it can go up
            //x has no direction, because no diagonals in snake
            if (snake.getYDir() != 1) {
                snake.setYDir(-1);
                snake.setXDir(0);
            }
